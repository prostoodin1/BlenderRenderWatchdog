...
<meta name="theme-color" content="#070a12"><link rel="manifest" href="/manifest.json"><title>Render Watchdog</title>
<style>
...
</style></head><body><main><div class="hero"><div><div class="muted">BLENDER RENDER WATCHDOG 2.4.2</div><h1 id="project">Waiting for render</h1><div id="detail" class="muted">Connecting…</div></div><div id="status" class="badge">OFFLINE</div></div>
...
class MobileDashboardServer:
    def __init__(
        ...
        history_provider: Callable[[], list[dict[str, object]]] | None = None,
    ...
    def start(self) -> str:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "BlenderRenderWatchdogMobile/2.4.2"
            ...
            def do_GET(self) -> None:  # noqa: N802
                ...
                if route == "/api/history":
                    history = dashboard.history_provider() if dashboard.history_provider else []
