...
</style></head><body><main><div class="hero"><div><div class="muted">BLENDER RENDER WATCHDOG 2.4.1</div><h1 id="project">Waiting for render</h1><div id="detail" class="muted">Connecting…</div></div><div id="status" class="badge">OFFLINE</div></div>
...
class MobileDashboardServer:
    ...
    def start(self) -> str:
        ...
        class Handler(BaseHTTPRequestHandler):
            server_version = "BlenderRenderWatchdogMobile/2.4.1"
